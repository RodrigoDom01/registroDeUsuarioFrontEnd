...
function validarUsu() {
    ...
    } else if(!user.toLowerCase().includes("yahoo.com.ar") && !user.toLowerCase().includes("gmail.com")) {
        document.getElementById("mensaje").innerHTML="El usuario debe contener el dominio yahoo.com.ar o gmail.com"
        document.getElementById("mensaje").className="text-danger fw-bold p-2 rounded"
    } else {
